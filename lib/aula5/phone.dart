...
/// Usage examples
void main() {
  SimCard vodafone = VodafoneSim();
  SimCard orange = OrangeSim();

  OldPhone oldPhone = OldPhone(vodafone);
  oldPhone.call('123456789');
  oldPhone.text('123456789', 'Hello from old phone!');

  IPhone iphone = IPhone(orange);
  iphone.call('987654321');
  iphone.text('987654321', 'Hello from iPhone!');
  iphone.takePhoto();
  iphone.playMusic('Shape of You');

  AndroidPhone android = AndroidPhone(vodafone);
  android.call('555555555');
  android.text('555555555', 'Hello from Android!');
  android.takePhoto();
  android.playMusic('Blinding Lights');
}
